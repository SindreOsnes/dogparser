import argparse
import os
from dogparser.parsers import hund, eier, innavl, oppdretter, tyskull, utstillingsamleres, poststed, siegervinner, kull, hdstat, utststat, kaaringer, nv, utststattotal, kaaringsbeskrivelse, sykdom, hdstatfarmorfar
